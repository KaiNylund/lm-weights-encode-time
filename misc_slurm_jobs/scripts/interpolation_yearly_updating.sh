...
eval_out_dir="./search_outputs/${MODEL}_${TASK}_interp_decay_yearly_updating/"
tv_out_dir="./interp_outputs/${MODEL}_${TASK}_interp_decay_yearly_updating"
out_dir="./models/${MODEL}_${TASK}_interp_decay_yearly_updating/"
mkdir -p $out_dir

n_pct_pts=1
prev_ckpt=$MODEL
for train_year in {2012..2016} #"2006-2008" "2009-2011" "2012-2014" "2015-2017" "2018-2020"
do
    #train_file="${poli_aff_dir}train/indivs/${train_year}.jsonl"
    train_file="${news_sum_dir}train/${train_year}.jsonl"
    #train_file="${aic_dir}train/${train_year}.jsonl"
    #train_file="${arxiv_dir}train/${train_year}_150000000_bytes"
    #train_file="${twitter_dir}train/year_${train_year}_200000000_bytes"
    #train_file="${wmt_dir}train_json/year_${train_year}_200000000_bytes"

    if [ ! -f $train_file ]; then
        echo "Missing train file for ${train_year}!"
    else
        echo "Training on ${train_year}!"

        cur_out_dir="${out_dir}up_to_${train_year}_interp"
        ...
        for eval_year in {2012..2016} #"2006-2008" "2009-2011" "2012-2014" "2015-2017" "2018-2020" #{2015..2020}
        do
            echo "Evaluating on ${eval_year}!"
            #eval_file="${aic_dir}dev/${eval_year}.jsonl"
            eval_file="${news_sum_dir}dev/${eval_year}.jsonl"
            ...
            #        --eval_output_dir ${eval_out_dir}up_to_${train_year}_eval_${eval_year} \
            #        --valid_file $eval_file\
            #        --identifier ${MODEL}_${TASK}_up_to_${train_year}_eval_${eval_year} \
