...
def main(model='facebook/opt-125m', experiment="dense", dataset='c4', dataset_config='en.noblocklist',
         ...
         debug=False, dry_mode=False, lora=False, eval_file=None, identifier=None,
         a_vec_dir=None, b_vec_dir=None, c_vec_dir=None, lm=False):
    DEBUG_MODE = debug
    DRY_MODE = dry_mode
    MODEL = model
    ...
    for sweep_name, grid in grids.items():
        run_grid(
            ...
            prefix=f'bash {ROOT_FOLDER}/scripts/run_task_analogy.sh',
